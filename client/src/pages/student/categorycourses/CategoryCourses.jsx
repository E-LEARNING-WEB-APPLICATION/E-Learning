    ...
    return (
        <div className="container py-5">
            ...
            <h2 className="fw-bold mb-4">
                Courses in <span className="text-primary">{categoryId}</span>
            </h2>
