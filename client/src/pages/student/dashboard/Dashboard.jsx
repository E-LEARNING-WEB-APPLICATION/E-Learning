...
const Dashboard = () => {
  ...
  const sampleTestimonials = [
    {
      ...
      review:
        "The course was extremely well structured and easy to follow. The instructor explained concepts clearly and the projects were very practical!",
      rating: 5,
    ...
    },
    {
      ...
      review:
        "Amazing content! The instructor made complex data topics very simple. The hands-on exercises were the best part!",
      rating: 4,
    ...
    },
    {
      ...
      review:
        "Best Android course I have taken! Very clear explanations and well-structured modules. Highly recommended.",
      rating: 5,
    ...
    },
    {
      ...
      review:
        "Loved the creative examples and Figma practice tasks. The instructor made UI/UX very fun to learn!",
      rating: 5,
  ...
  return (
    <div>
      ...
      <StudentDashboardCategoryCourse courses={course} categories={category} />
      <StudentDashboardInstructor instructors={instructors} />
      <StudentDashboardTestimonials sampleTestimonials={sampleTestimonials} />
    </div>
  );
};
